...
def install_go_mod_dependencies(workspace_name = "buildbuddy"):
    ...
    go_repository(
        ...
        sum = "h1:WUJzYHmDlfHdi5MuEb+pAUFhRDRi3GhO9x3Vc6gk6PQ=",
        version = "v0.7.0-buildbuddy",
    )
    go_repository(
    ...
    go_repository(
        ...
        build_directives = [
            "gazelle:resolve go cel.dev/expr @dev_cel_expr//proto/cel/expr:expr_go_proto",
        ],
    ...
    go_repository(
        ...
        sum = "h1:/llYvGj7j8ocRDagvHfJW1cM7url9Oa94IScX37eILk=",
        version = "v1.69.0",
    )
    go_repository(
